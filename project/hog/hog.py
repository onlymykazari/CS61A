...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            now_num_roll = strategy0(score0, score1)
            score0 = update(now_num_roll, score0, score1, dice)
            who = 1
        else:
            now_num_roll = strategy1(score1, score0)
            score1 = update(now_num_roll, score1, score0, dice)
            who = 0
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 < goal:
        score1 = 0
        while score1 < goal:
            now_count = strategy(score0, score1)
            if original_count is not None:
                if original_count != now_count:
                    return False
            else:
                original_count = now_count
            score1 = score1 + 1
        score0 = score0 + 1
    return True
...
def run_experiments():
    ...
    print('conservative_strategy win rate:', average_win_rate(conservative_strategy))
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    now_score = square_update(0, score, opponent_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    dice = six_sided
    averaged_dice = make_averaged(roll_dice, 40)
    averaged_score_for_always_roll_six = averaged_dice(6, dice)
    now_score = square_update(0, score, opponent_score)
    if now_score - score > averaged_score_for_always_roll_six:
        return 0
    else:
        return 6
    # END PROBLEM 12
...
def conservative_strategy(score, opponent_score):
    """Write a brief description of your final strategy.
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    dice = six_sided
    averaged_dice = make_averaged(roll_dice, 40)
    averaged_score_for_always_roll_one = averaged_dice(1, dice)
    averaged_score_for_always_roll_two = averaged_dice(2, dice)
    if square_update(0,score,opponent_score,dice) >= 100:
        return 0
    elif averaged_score_for_always_roll_one + score >= 100:
        return 1
    elif averaged_score_for_always_roll_two + score >= 100:
        return 2
    else:
        return 6
    # END PROBLEM 12
